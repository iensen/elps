/* Generated By:JJTree&JavaCC: Do not edit this line. ElpsTranslator.java */
package parser;
import java.io.*;
import sorts.*;
...
@ SuppressWarnings("all") public class ElpsTranslator/*@bgen(jjtree)*/implements ElpsTranslatorTreeConstants, ElpsTranslatorConstants {/*@bgen(jjtree)*/
  protected JJTElpsTranslatorState jjtree = new JJTElpsTranslatorState();// mapping from sort names to sort expressions assigned to the sorts
...
public static void main(String [] args)
 ...
 /*@bgen(jjtree) unlabeledProgramCrRule */
  ...
  Token t;
    ...
    {if (true) return new Token(ElpsTranslatorConstants.ORRSEP, ":-");}
      break;
    default:
      jj_la1[32] = jj_gen;
      jj_consume_token(-1);
 ...
 /*@bgen(jjtree) nonRelAtom */
  ...
  Pair n;
    ...
    for(String prefix: disallowedPrefixes)
    {
        ...
        {
             {if (true) throw new ParseException("ERROR: predicate names starting from "+ prefix +" are not allowed; line " + n.first.beginLine + " column " + n.first.beginColumn);}
        }
    }
    ...
    if(predS1.subj!=0)
    {
        {if (true) throw new ParseException("ERROR: subjective literals are only allowed in the bodies of rules; line " + n.first.beginLine + " column " + n.first.beginColumn);}
    }
      if (jj_2_16(1)) {
        tList = termList();
 ...
 /*@bgen(jjtree) extendedNonRelAtom */
  ...
  Pair n;
    ...
    {
        {if (true) throw new ParseException("ERROR: predicate names starting from k_ or m_ are not allowed; line " + n.first.beginLine + " column " + n.first.beginColumn);}
    }

    if(t!=null && (predS1.subj!=0))
    {
        System.out.println(predS1.negatedSubj);
        {if (true) throw new ParseException("ERROR: not is not allowed before subjective literals " + n.first.beginLine + " column " + n.first.beginColumn);}
    }
      if (jj_2_23(1)) {
        tList = termList();
      if (!n.second && tList != null)
 ...
 /*@bgen(jjtree) predSymbol */
  ...
  jjtree.openNodeScope(jjtn000);Token t, poundSign = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case KIDENTIFIER:
        t = jj_consume_token(KIDENTIFIER);
    jjtree.closeNodeScope(jjtn000, true);
    jjtc000 = false;
    ...
    {if (true) return new Pair(jjtn000, false);}
      ...
      default:
        ...
        if (jj_2_26(2)) {
          ...
          t = jj_consume_token(KIDENTIFIER_WITH_OP);
    jjtree.closeNodeScope(jjtn000, true);
    jjtc000 = false;
    if(t.image.indexOf("K$")!=-1)
    {
 ...
 /*@bgen(jjtree) atomSequence */
  ...
  private boolean jj_3_26() {
    ...
    if (jj_scan_token(KIDENTIFIER_WITH_OP)) return true;
    return false;
  }
  ...
  private boolean jj_3R_51() {
    if (jj_scan_token(KIDENTIFIER)) return true;
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1f,0x0,0x8,0x0,0x20000,0x10000,0x10000,0x14000400,0x0,0x0,0x400,0x400,0x100,0x200,0x4001080,0x0,0x4000000,0x0,0x0,0x0,0xe400,0x400,0x0,0x0,0x0,0xc0000000,0xf400,0xf400,0xf400,0xf400,0x80000000,0xc0000000,0x40000000,0x0,0xc00,0x0,0x3f80000,0x3f80000,0x0,0x0,0x0,0x0,0xc40,0x40,0x10000,0x60000,0x4001000,0x10000,0x60000,0x400,0x400,0x0,0x3f80000,0x280000,0x0,0x0,0xc00,0x0,0xc40,0x3f80000,0x0,0x0,0x0,0x0,0x0,0x6,0x6,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x2000,0x0,0x800,0x0,0x200000,0x200000,0x2000,0x2,0x2,0x0,0x0,0x0,0x0,0x0,0x8,0x0,0x2,0x800,0x2000,0x0,0x0,0x2000,0x2,0x800,0x1,0x0,0x0,0x0,0x0,0x0,0x4,0x4,0x4,0x7e000,0x40,0x0,0x0,0x10,0x8,0x2,0x2,0x7e000,0x0,0x200000,0x0,0x0,0x200000,0x0,0x4000,0x4000,0x2,0x0,0x0,0x2000,0x2000,0x0,0x76000,0x7e000,0x0,0x10,0x2,0x8,0x780,0x2,0x0,0x0,};
   }
  ...
  public ElpsTranslator(java.io.InputStream stream) {
     this(stream, null);
  }
  ...
  public ElpsTranslator(ElpsTranslatorTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(ElpsTranslatorTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
