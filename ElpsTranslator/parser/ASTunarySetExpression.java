...
class ASTunarySetExpression extends SimpleNode {
  ...
  public ASTunarySetExpression(ElpsTranslator p, int id) {
    super(p, id);
  }
  
  public String toString() {
	  switch(((SimpleNode)this.jjtGetChild(0)).getId()) {
	    case ElpsTranslatorTreeConstants.JJTCURLYBRACKETS: return ((ASTcurlyBrackets)this.jjtGetChild(0)).toString();
	    case ElpsTranslatorTreeConstants.JJTSORTNAME: return "#"+((ASTsortName)this.jjtGetChild(0)).toString();
