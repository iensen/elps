...
public class InstanceGenerator {
	...
	private HashSet<String> generateInstances(ASTunarySetExpression une,boolean generateRecords)
		...
		if (child.getId() == ElpsTranslatorTreeConstants.JJTSORTNAME) {
			return generateInstances_p(sortNameToExpression.get(child
					.toString()),generateRecords);
		} else if (child.getId() == ElpsTranslatorTreeConstants.JJTCURLYBRACKETS) {
		...
		} else if(child.getId() == ElpsTranslatorTreeConstants.JJTSETEXPRESSION) { // setExpression
