...
\end{equation*}
\st
Where $pred\_symbol$ is an identifier(referred to as a predicate symbol) and  $\#sortName_1$,\dots,$\#sortName_n$ are sorts defined in sort definitions section of the program.
