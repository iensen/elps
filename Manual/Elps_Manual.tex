...
$id_1$ is lexicographically \footnote{ The Unicode (UTF-16) is used for  ordering of individual characters} smaller than or equal to  $id_2$, and the length of $id_1$ is less than or equal to the length of $id_2$. That is,  $id_1 \leq id_2$ and $|id_1| \leq |id_2|$.
